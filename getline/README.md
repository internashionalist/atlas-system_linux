...
- Here’s the file used for the example below: [zero](https://github.com/O-01/atlas-system_linux/blob/main/getline/test/zero)

```
julien@ubuntu:~/getline$ cat 100-main.c
#include <fcntl.h>
#include <stdio.h>
#include <unistd.h>
#include <stdlib.h>
...
julien@ubuntu:~/getline$ cat zero
line 1 Holberton.....
line 2 still line 2
line 3 ......School()
julien@ubuntu:~/getline$ gcc -g -Wall -Wextra -pedantic 100-main.c _getline.c && ./a.out
